...
#    do 
    ...
    echo ''
    echo [INSERT INTO marvin_test.${type}_${table_name}_${org_id}_etl_hist]
    #mysql --login-path=$dest_login_path -e "INSERT INTO marvin_test.${type}_${table_name}_${org_id}_etl_hist SELECT null, accu_id, fpc, created_at, domain, behavior, traffic_type, referrer, campaign, source_medium, event_type, page_title, page_url, session, session_type, updated_at FROM ${project_name}.${type}_${table_name}_${org_id}_etl;"
