...
echo ''
echo [Get the org_id]
##mysql --login-path=${src_login_path}_cms -e "$sql_0" > $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id_8.txt 2>>$error_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id.error
...
do 
    ...
    do
        ...
        mysql --login-path=${src_login_path}_cms -e "$sql_3" > $export_dir/$src_login_path/$project_name/${project_name}.${type_s}_${table_name}_${org_id}_${db_id}_src.txt 2>>$error_dir/$src_login_path/$project_name/${project_name}.${type_s}_${table_name}_${org_id}_${db_id}_src.error
...
#done < /root/datapool/export_file/cdp/web/web.cdp_org_id_8.txt
