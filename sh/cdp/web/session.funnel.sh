...
do 
    ...
    mysql --login-path=$dest_login_path -e "DROP TABLE IF EXISTS ${project_name}.${type}_${table_name}_${org_id}_temp" 2>>$error_dir/$src_login_path/$project_name/$project_name.${type}_${table_name}_${org_id}_temp.error 
    ...
    do 
        ...
        mysql --login-path=$dest_login_path -e "$sql_16" 2>>$error_dir/$src_login_path/$project_name/${project_name}.${type}_${table_name}_${org_id}_temp.error
        ...
        INSERT IGNORE INTO ${project_name}.${type}_${table_name}_${org_id}_src
            ...
            from (
                select
                    ...
                    funnel_id, 
                    layer_id,
                    row_number () over (partition by fpc, session, funnel_id order by layer_id) rid
