...
echo ''
echo [Get the org_id]
#mysql --login-path=${src_login_path}_master -e "$sql_0" > $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id_14.txt 2>>$error_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id_14.error
