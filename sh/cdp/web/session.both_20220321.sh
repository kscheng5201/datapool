        ...
        do 
            export sql_5="
                ...
                where created_at < UNIX_TIMESTAMP('${vDate}' + interval 1 day)
                    ...
                    and referrer like concat('%', '$(echo ${referrer_detail} | cut -d = -f 1)', '.', '%')
                ;"
            echo $sql_5
            #### Export Data ####
            echo ''
            ...
            mysql --login-path=$dest_login_path -e "LOAD DATA LOCAL INFILE '$export_dir/$src_login_path/$project_name/${project_name}.${table_name}_${org_id}_${db_id}_${referrer_detail}_src.txt' IGNORE INTO TABLE ${project_name}.${type}_${table_name}_${org_id}_src IGNORE 1 LINES;" 2>>$error_dir/$src_login_path/$project_name/${project_name}.${type}_${table_name}_${org_id}_${db_id}_${referrer_detail}_src.error 
