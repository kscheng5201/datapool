...
sh /root/datapool/sh/cdp/web/12/prod.session.both.sh ${vDate}

sh /root/datapool/sh/cdp/web/12/prod.session.kpi.sh ${vDate}
sh /root/datapool/sh/cdp/web/12/prod.session.page_1126.sh ${vDate}

sh /root/datapool/sh/cdp/web/12/prod.both.onliner.sh ${vDate}
sh /root/datapool/sh/cdp/web/12/prod.person.page_1126.sh ${vDate}

sh /root/datapool/sh/cdp/web/12/prod.both.event.sh ${vDate}

sh /root/datapool/sh/cdp/web/12/prod.session.funnel.sh ${vDate}
