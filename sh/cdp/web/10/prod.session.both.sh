...
echo ''
echo [Get the org_id]
#mysql --login-path=${src_login_path}_master -e "$sql_0" > $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id_10.txt 2>>$error_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id.error
#sed -i '1d' $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id_10.txt
...
do 
    ...
    mysql --login-path=${src_login_path}_master -e "$sql_1" > $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_${org_id}_db_id_10.txt 2>>$error_dir/$src_login_path/$project_name/$project_name.${src_login_path}_${org_id}_db_id.error
    sed -i '1d' $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_${org_id}_db_id_10.txt
    ...
    done < $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_${org_id}_db_id_10.txt
            ...
            from (
                ...
                from (
                    ...
                    from (
                        select 
                            s.*, 
                            row_number () over (partition by fpc order by created_at) rid
    ...
    echo $sql_12a
    mysql --login-path=$dest_login_path -e "$sql_12a" 2>>$error_dir/$src_login_path/$project_name/${project_name}.${type}_${table_name}_${org_id}_sql12a.error
                ...
                from (
                    ...
                    from (
                        select 
                            ...
                            s.page_title, 
                            s.page_url, 
                            row_number () over (partition by ifnull(g.fpc, s.fpc) order by created_at) rid
    ...
    echo $sql_12b
    mysql --login-path=$dest_login_path -e "$sql_12b" 2>>$error_dir/$src_login_path/$project_name/${project_name}.${type}_${table_name}_${org_id}_sql12b.error
    ...
    mysql --login-path=$dest_login_path -e "$sql_13" 2>>$error_dir/$src_login_path/$project_name/${project_name}.${type}_${table_name}_${org_id}_etl_sql13.error
...
echo ''
echo $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id_10.txt
cat $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id_10.txt
