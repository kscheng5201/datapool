...
sh /root/datapool/sh/cdp/web/6/prod.session.both.sh ${vDate}

#sh /root/datapool/sh/cdp/web/6/prod.session.kpi.sh ${vDate}
sh /root/datapool/sh/cdp/web/6/prod.session.page_1228.sh ${vDate}

#sh /root/datapool/sh/cdp/web/6/prod.both.onliner.sh ${vDate}
sh /root/datapool/sh/cdp/web/6/prod.person.page_1228.sh ${vDate}

#sh /root/datapool/sh/cdp/web/6/prod.both.event.sh ${vDate}

#sh /root/datapool/sh/cdp/web/6/prod.session.funnel.sh ${vDate}
