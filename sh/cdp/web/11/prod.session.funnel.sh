...
echo ''
echo [Get the org_id]
#mysql --login-path=$src_login_path -e "$sql_0" > $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id_11.txt 2>>$error_dir/$src_login_path/$project_name/$project_name.${src_login_path}_org_id_11.error
...
#done < /root/datapool/export_file/cdp/web/web.cdp_org_id_11.txt
echo ''
echo 'end: ' `date`
