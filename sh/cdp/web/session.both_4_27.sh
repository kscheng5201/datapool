    ...
    do 
        ...
        do 
            export sql_5="
                ...
                where created_at >= UNIX_TIMESTAMP(date_format(now(), '%Y-%m-%d %H:00:00') - interval 1 minute) 
                    and created_at < UNIX_TIMESTAMP(date_format(now(), '%Y-%m-%d %H:00:00') - interval 1 minute + interval 1 minute)
        ...
        export sql_9="
            ...
            where a.created_at >= UNIX_TIMESTAMP(date_format(now(), '%Y-%m-%d %H:00:00') - interval 1 minute) 
                and a.created_at < UNIX_TIMESTAMP(date_format(now(), '%Y-%m-%d %H:00:00') - interval 1 minute + interval 1 minute)
            ;"
        echo $sql_9
        #### Export Data ####
        echo ''
