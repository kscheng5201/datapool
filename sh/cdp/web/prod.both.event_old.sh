...
do 
    ...
    do
        ...
        mysql --login-path=$dest_login_path -e "LOAD DATA LOCAL INFILE '$export_dir/$src_login_path/$project_name/${project_name}.${type_s}_${table_name}_${org_id}_${db_id}_src.txt' INTO TABLE ${project_name}.${type_s}_${table_name}_${org_id}_src IGNORE 1 LINES;" 2>>$error_dir/$src_login_path/$project_name/${project_name}.${type_s}_${table_name}_${org_id}_${db_id}_src.error
    ...
    do
        ...
        do 
            export sql_7="            
                INSERT IGNORE INTO ${project_name}.${type_s}_${table_name}_${org_id}_pre
                    select 
                        null serial, 
                        fpc,
                        domain,
			...
			type,  
                ...
                ;"
            echo ''
            echo [INSERT IGNORE INTO ${project_name}.${type_s}_${table_name}_${org_id}_etl]
...
export sql_9="
    INSERT IGNORE INTO ${project_name}.${type_s}_${table_name}_${org_id}_etl
        select 
            null serial, 
            a.fpc fpc, 
            a.domain, 
        ...
        from (
            select
                ...
                content, 
                aa.created_at
            from ${project_name}.${type_s}_${table_name}_${org_id}_pre aa
                left join uuid.accu_mapping_${org_id} cc
                on aa.fpc = cc.id 
            where id_type = 'fpc'
            ) a
    ...
    #DROP TABLE IF EXISTS ${project_name}.${type_s}_both_${org_id}_src;
    echo ''
    echo [INSERT IGNORE INTO ${project_name}.${type_s}_${table_name}_${org_id}_etl]
    echo $sql_9
	...
	# the daily data is no needed!
        ...
        INSERT IGNORE INTO ${project_name}.${type_p}_${table_name}_${org_id}_fpc
            select 
                null serial, 
                '${vDate}' + interval 1 day tag_date, 
                'daily' span, 
