...
do 
    echo ''
    echo [DROP TABLE ${project_name}.${type}_${table_name}_${org_id}_etl]
    echo [DROP TABLE ${project_name}.${type}_${table_name}_${org_id}_src]
    echo [DROP TABLE ${project_name}.${type}_${table_name}_${org_id}_src_d]
    ...
    mysql --login-path=${dest_login_path} -e "DROP TABLE ${project_name}.${type}_${table_name}_${org_id}_src_d;"
    ...
    export sql_7="
        ...
        ;
        DROP TABLE ${project_name}.${type}_${table_name}_${org_id}_src_d
        ;"
    echo ''
