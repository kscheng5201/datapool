...
do 
    ...
    export sql_8="   
        ...
        ;
        CREATE TABLE IF NOT EXISTS ${project_name}.${type_s}_${table_name}_${org_id}_etl_log (
            serial int NOT NULL AUTO_INCREMENT COMMENT 'auto_increment Serial Number' unique,
            campaign_id int(11) unsigned NOT NULL DEFAULT '0' COMMENT 'campaign 編號',
            utm_id int(11) NOT NULL DEFAULT '0' COMMENT 'campaign_utm 流水編號',            
            fpc varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '瀏覽器指紋碼 fingerprint code', 
            ...
            KEY idx_content (content) USING BTREE,
            KEY idx_created_at (created_at) USING BTREE 
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='多日 event etl 資料（行銷漏斗用）' 
        ;"
    echo ''
    ...
    export sql_9="
        ...
        INSERT INTO ${project_name}.${type_s}_${table_name}_${org_id}_etl_log
            select 
                null serial, 
                campaign_id, 
                utm_id,
        ...
        ;
        ALTER TABLE ${project_name}.${type_s}_${table_name}_${org_id}_etl_log AUTO_INCREMENT = 1
        ;"
    echo ''
    echo [INSERT INTO ${project_name}.${type_s}_${table_name}_${org_id}_etl]
    echo $sql_9
