...
do 
    ...
    export sql_4="   
        CREATE TABLE IF NOT EXISTS ${project_name}.${type_s}_${table_name}_${org_id}_pre (
            ...
            token varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'line token',
            ...
            PRIMARY KEY (token, domain, event, attribute, content, created_at) USING BTREE, 
    ...
    export sql_10="
        ...
        CREATE TABLE IF NOT EXISTS ${project_name}.${type_p}_${table_name}_${org_id}_token (
            ...
            created_at timestamp NOT NULL DEFAULT current_timestamp COMMENT '建立時間', 
            updated_at timestamp NOT NULL DEFAULT current_timestamp on update current_timestamp COMMENT '更新時間',
            primary key (tag_date, token, domain, event, attribute, content),
            key idx_tag_date (tag_date),
            key idx_start_date (start_date),  
            key idx_token (token), 
            key idx_domain (domain), 
