...
do 
    ...
    do 
        export sql_11="
            select concat(logic, ifnull(logic_content, '')) layer1
            from codebook_cdp.funnel_config
            where org_id = ${org_id}
    ...
    export sql_20a="
        ...
        ;"
    echo ''
    echo [UPDATE the funnel status at codebook_cdp.funnel at the real org_id]
    mysql --login-path=$dest_login_path -e "$sql_20a" 2>>$error_dir/$src_login_path/$project_name/codebook_cdp.funnel.error
