...
####################################################
# Project: Web 互動分析儀表板
# Branch: ${project_name}_event_raw_data 標記 session
# Author: Benson Cheng
...
do
    export sql_0="
        CREATE TABLE IF NOT EXISTS ${project_name}.${table_name}_raw_data_${org_id} (
           ...
           token_type varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'token 類型。web-${project_name}; line-token; app-token 等',
