...
echo [the directory]
echo $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_ord_id.txt
cat $export_dir/$src_login_path/$project_name/$project_name.${src_login_path}_ord_id.txt
echo [end at `date`]
