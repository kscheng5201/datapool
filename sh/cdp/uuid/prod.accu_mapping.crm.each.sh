...
do 
    ...
    mysql --login-path=$dest_login_path -e "DROP TABLE IF EXISTS ${project_name}.${table_name}_crm_${org_id}_mid_bfpc_f;"
    echo ''
    ...
    export sql_2="
        ...
        ;
        CREATE TABLE IF NOT EXISTS ${project_name}.${table_name}_crm_${org_id}_mid_bfpc_f (
            accu_id varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '由 ##mysql uuid() 機制所產生的 id',
            browser_fpc varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '透過 tracker 比對後的指紋碼 fingerprint code',            
    ...
    export sql_5a="            
        INSERT INTO ${project_name}.${table_name}_crm_${org_id}_mid_bfpc_f
        ...
        DELETE
        FROM ${project_name}.${table_name}_crm_${org_id}_mid_bfpc_f
        WHERE rid >= 2
        ;
        
        UPDATE ${project_name}.${table_name}_${org_id} a
            INNER JOIN ${project_name}.${table_name}_crm_${org_id}_mid_bfpc_f b
    ...
    export sql_5b="     
        INSERT INTO ${project_name}.${table_name}_crm_${org_id}_mid_member_f
